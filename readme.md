...
Fall-Detected Detection Data Set in YOLOP format

Over ten thousand images, each labeled with a unique tag.
The dataset is divided into one category: Fall-Detected - detecting falls.
